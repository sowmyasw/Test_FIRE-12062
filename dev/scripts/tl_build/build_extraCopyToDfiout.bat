...
xcopy %BASE_DIR%\sources\QAProduct\dev\src\bin %BASE_DIR%\dfiout\module-0\bin /s /e
...
xcopy %BASE_DIR%\sources\QAProduct\dev\src\lib %BASE_DIR%\dfiout\module-0\lib /s /e

mkdir %BASE_DIR%\output\sources
xcopy %BASE_DIR%\sources\QAProduct\dev\src\src %BASE_DIR%\output\sources /s /e
xcopy %BASE_DIR%\sources\QAProduct\dev\src\src %BASE_DIR%\dfiout\module-0\src /s /e
